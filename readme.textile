...
# *Mandatory:* Rename all the modules you want this module to install from .module to .module.php files and place
them all in a common directory along with a copy of this module file.
# _Optional but recommended:_ If your project delivers, say, an SMS sending package of modules then...
...
# *Madatory:* Zip up or otherwise deliver the entire directory to your users.
